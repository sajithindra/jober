...
import { defineNuxtModule, isNuxt2, requireModule, addTemplate, resolvePath, createResolver, installModule, addVitePlugin, isNuxt3, addDevServerHandler, findPath } from '@nuxt/kit';
import 'ufo';
